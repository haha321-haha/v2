          ...
          >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                {/* 4. 健康指南 */}
                <Link href={`/${locale}/health-guide`} className="block">
                  <article className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-200 group h-full">
                    <div
                      className="w-16 h-16 bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-200"
                      aria-hidden="true"
                    >
                      <svg
                        className="w-8 h-8 text-white"
                ...
                {/* 6. 场景方案 */}
                <Link href={`/${locale}/scenario-solutions`} className="block">
                  <article className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-200 group h-full">
                    <div
                      className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-200"
                      aria-hidden="true"
                    >
                      <svg
                        className="w-8 h-8 text-white"
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-4 group-hover:text-cyan-600 transition-colors">
                      {t("home.quickLinks.solutions")}
                    </h3>
                    <p className="text-gray-600 leading-relaxed">
                      {t("home.quickLinks.solutionsDesc")}
                    </p>
                    <div className="mt-4 text-cyan-600 font-medium opacity-0 group-hover:opacity-100 transition-opacity">
